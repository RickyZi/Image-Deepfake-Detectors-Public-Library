...
python3 launcher.py --detector R50_nodown --phases both --dataset seasons/spring-SP01 --ft --r50unfreezeL4 --social telegram
...
python3 launcher.py --detector R50_nodown --phases both --dataset style/bw01 --ft  --r50unfreezeL4 --social telegram
