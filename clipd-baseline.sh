...
python launcher.py --detector CLIP-D --phases test  --weights-name lora_r4_qv --tf2k True --ft --dataset style/cinematic2_CN11 --social telegram # wrong name -> cinemantic instead of cinematic
...
# python launcher.py --detector CLIP-D --phases test  --weights-name lora_r4_qv --tf2k True --ft --dataset adaptive/sky-bluedrama --social twitter
# python launcher.py --detector CLIP-D --phases test  --weights-name lora_r4_qv --tf2k True --ft --dataset adaptive/subject-pop --social twitterd