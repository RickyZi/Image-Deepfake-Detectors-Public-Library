...
#     # if there is already an aggregated_metrics.json file, skip the folder ("metrics already computed for out_path")
#     # if out_path.exists():
#     #     print("")

#     # if a json file exists, and its not empty -> skip
    
#     try:
#         if not Path(out_path).exists():
#             print(f"metrics already computed in {out_path} - skipping")
#             return
